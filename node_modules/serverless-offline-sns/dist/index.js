            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.snsAdapter.subscribe(fn, function () { return _this.createHandler(fn); }, data.TopicArn)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 6];
                    case 3:
                        if (!(typeof snsConfig.arn === "string")) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.snsAdapter.subscribe(fn, function () { return _this.createHandler(fn); }, snsConfig.arn)];
                    case 4:
                        _a.sent();
                        return [3 /*break*/, 6];
                    case 5:
