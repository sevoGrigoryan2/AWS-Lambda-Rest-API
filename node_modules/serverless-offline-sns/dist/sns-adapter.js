...
var SNSAdapter = /** @class */ (function () {
    ...
    SNSAdapter.prototype.subscribe = function (fn, getHandler, arn) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        this.app.post("/" + fn.name, function (req, res) {
                            ...
                            getHandler()(event, _this.createLambdaContext(fn), function (data) {
                                res.send(data);
                                process.env = oldEnv;
                            });
                        });
    ...
    SNSAdapter.prototype.convertPsuedoParams = function (topicArn) {
